...
class ResponsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create response" do
    assert_difference("Response.count") do
      post responses_url, params: { response: { person_id: @response.person_id, questionnaire_id: @response.questionnaire_id } }
    end
  ...
  test "should update response" do
    patch response_url(@response), params: { response: { person_id: @response.person_id, questionnaire_id: @response.questionnaire_id } }
