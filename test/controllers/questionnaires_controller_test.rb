...
class QuestionnairesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create questionnaire" do
    assert_difference("Questionnaire.count") do
      post questionnaires_url, params: { questionnaire: { name: @questionnaire.name, questionnaire_type_id: @questionnaire.questionnaire_type_id, slug: @questionnaire.slug, status: @questionnaire.status } }
    end
  ...
  test "should update questionnaire" do
    patch questionnaire_url(@questionnaire), params: { questionnaire: { name: @questionnaire.name, questionnaire_type_id: @questionnaire.questionnaire_type_id, slug: @questionnaire.slug, status: @questionnaire.status } }
